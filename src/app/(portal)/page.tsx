...
export const metadata: Metadata = {
  title: "Base Imob — Encontre seu imóvel ideal",
  description: "O maior ecossistema imobiliário da região. Apartamentos, casas, lançamentos e oportunidades em um só lugar.",
...
export default async function PortalPage() {
  ...
  const [
    { data: rawProperties },
    { data: construtorасData },
    { data: imobiliariasData },
    { data: rawAds },
    { count: corretoresCount },
  ] = await Promise.all([
    admin
      .from("properties")
  ...
  return (
    <>
      ...
      <HomeClient
        ...
        corretoresCount={corretoresCount ?? 0}
      />
    </>
  )
}
