    ...
    <div className="bg-background min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-5 py-10">
        ...
        <div className="mb-8">
          ...
          <h1 className="font-serif text-3xl font-bold text-foreground mb-2">Imobiliárias</h1>
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="flex items-center justify-between mt-auto pt-4 border-t border-border">
                      {org.availableCount > 0 ? (
                        ...
                        <span className="text-xs font-sans text-muted-foreground/50">Parceira do portal</span>
                      )}
