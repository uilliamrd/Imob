  ...
  return (
    <div className="px-4 py-6 lg:p-8 max-w-5xl">
      <PageHeader
        ...
        description="Leads recebidos sem referência de corretor são distribuídos automaticamente por ordem de pontuação. Corretores com mais pontos têm prioridade, mas dentro do mesmo score o que há mais tempo sem receber leads é o próximo."
      />
