...
export default async function ConstrutoraPage({ params, searchParams }: PageProps) {
  ...
  const data = raw ?? (slug === "meridian" || slug === "construtora-meridian" ? {
    ...
    properties: [
      { id: "1", code: 1001, title: "Torre A — Apt 1201", description: null, price: 2850000, features: { suites: 4, vagas: 3, area_m2: 198, andar: 12 }, tags: ["VM", "MD", "AL"], status: "disponivel" as const, visibility: "publico" as const, created_by: "1", org_id: "demo", development_id: null, images: [], video_url: null, address: null, neighborhood: "Leblon", city: "Rio de Janeiro", slug: "torre-a-apt-1201", created_at: "", updated_at: "" },
      { id: "2", code: 1002, title: "Torre A — Apt 1101", description: null, price: 2650000, features: { suites: 3, vagas: 2, area_m2: 165, andar: 11 }, tags: ["VM", "VV"], status: "reserva" as const, visibility: "publico" as const, created_by: "1", org_id: "demo", development_id: null, images: [], video_url: null, address: null, neighborhood: "Leblon", city: "Rio de Janeiro", slug: "torre-a-apt-1101", created_at: "", updated_at: "" },
      { id: "3", code: 1003, title: "Torre B — Cobertura", description: null, price: 6200000, features: { suites: 5, vagas: 4, area_m2: 420 }, tags: ["CB", "VM", "MD", "AL"], status: "disponivel" as const, visibility: "publico" as const, created_by: "1", org_id: "demo", development_id: null, images: [], video_url: null, address: null, neighborhood: "Leblon", city: "Rio de Janeiro", slug: "torre-b-cobertura", created_at: "", updated_at: "" },
      { id: "4", code: 1004, title: "Torre B — Apt 901", description: null, price: 1980000, features: { suites: 3, vagas: 2, area_m2: 142, andar: 9 }, tags: ["VG", "SC"], status: "vendido" as const, visibility: "publico" as const, created_by: "1", org_id: "demo", development_id: null, images: [], video_url: null, address: null, neighborhood: "Leblon", city: "Rio de Janeiro", slug: "torre-b-apt-901", created_at: "", updated_at: "" },
