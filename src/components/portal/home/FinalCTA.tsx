...
export function FinalCTA() {
  return (
    <section className="px-4 py-24 bg-[var(--forest)]">
      <div className="max-w-4xl mx-auto text-center">
        <p className="text-[10px] uppercase tracking-[0.5em] font-sans mb-4 text-[var(--gold)]">
          Oportunidade
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/#buscar"
            className="px-8 py-4 bg-[var(--gold)] text-[#0F0F0F] text-xs uppercase tracking-[0.25em] font-sans font-semibold rounded-xl transition-all duration-200 hover:scale-[1.02]"
          >
            Encontrar imóvel
          </Link>
          <Link
