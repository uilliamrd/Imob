      ...
      <header className="hidden lg:flex sticky top-0 z-30 items-center justify-between px-8 h-[60px] bg-background/80 backdrop-blur-xl border-b border-border/50 flex-shrink-0 gap-4">
        ...
        <div className="flex items-center gap-1.5 min-w-0">
          {breadcrumb && breadcrumb.length > 0 ? (
            <nav className="flex items-center gap-1 text-sm font-sans overflow-hidden">
              <Link href="/dashboard" className="text-muted-foreground hover:text-[var(--primary-default)] transition-colors shrink-0">
                Início
              </Link>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-2.5 px-3.5 py-2 rounded-md bg-muted/50 border border-border/60 text-muted-foreground text-xs font-sans hover:border-[var(--primary-default)]/30 hover:bg-muted/80 hover:text-foreground transition-all duration-200"
          >
            <Search size={13} />
          ...
          <Link
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-md bg-[var(--primary-default)] text-white hover:bg-[var(--primary-hover)] text-xs font-sans transition-all duration-200 shadow-sm shadow-[var(--primary-default)]/20 font-medium"
          >
            <Zap size={12} />
          ...
          <div className="relative" ref={menuRef}>
            <button
              ...
              className="flex items-center gap-2 pl-1.5 pr-2.5 py-1.5 rounded-md border border-border/60 bg-muted/40 hover:border-[var(--primary-default)]/30 hover:bg-muted/70 transition-all duration-200"
            >
              {userAvatar ? (
                <Image src={userAvatar} alt={userName} width={26} height={26} className="w-[26px] h-[26px] rounded-lg object-cover" />
              ) : (
                <div className="w-[26px] h-[26px] rounded-lg bg-[var(--primary-subtle)] border border-[var(--primary-default)]/20 flex items-center justify-center shrink-0">
                  <span className="text-[var(--primary-default)] font-serif font-bold text-xs">{firstName[0]?.toUpperCase()}</span>
                </div>
              )}
