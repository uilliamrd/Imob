    ...
    <div ref={ref} className="relative h-screen overflow-hidden">
      ...
      >
        ...
        <motion.button
          ...
          className="mt-12 px-10 py-4 border border-gold text-gold hover:bg-gold hover:text-foreground transition-all duration-500 text-sm uppercase tracking-[0.2em] font-sans"
        >
          Explorar Unidades
        </motion.button>
      </motion.div>
